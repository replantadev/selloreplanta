...
Este plugin añade un sello de carbono negativo en el footer del sitio web si el dominio está alojado en Replanta. Puedes elegir entre un modo claro u oscuro para el sello.
